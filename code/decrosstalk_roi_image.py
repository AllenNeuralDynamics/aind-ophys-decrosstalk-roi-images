...
def decrosstalk_movie_roi_image(oeid, paired_reg_fn, input_dir, pixel_size=0.78, max_num_epochs=10, num_frames_avg=1000,
...
def decrosstalk_roi_image_single_pair(oeid, paired_reg_fn, input_dir, pix_size,start_frame=1000, num_frames_avg=1000,
